...
const layoutClasses =
  'z-[1] relative flex flex-col min-h-screen bg-[linear-gradient(135deg,rgba(215,230,255,1)_0%,rgba(243,219,246,1)_50%,rgba(240,220,247,1)_55%,rgba(217,227,255,1)_100%)]'
