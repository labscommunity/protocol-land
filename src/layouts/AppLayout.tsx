...
const afterClasses =
  'after:content-[""] after:bg-[image:var(--bg-left-btm-img-url)] after:bg-no-repeat after:bg-left-top after:left-0 after:bottom-0 after:absolute after:w-[472px] after:h-[354px]'
const beforeClasses =
