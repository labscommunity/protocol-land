...
export default function PullRequestRow({ status, author, id, title, timestamp }: Props) {
  ...
  return (
    <div onClick={handlePRRowClick} className="flex cursor-pointer justify-between hover:bg-liberty-light-300 items-center gap-2 py-2 px-4 border-b-[1px] border-liberty-light-600 last:border-b-0">
