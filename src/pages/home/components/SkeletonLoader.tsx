    ...
    <div className="w-full flex justify-between items-start border border-primary-500 rounded-md p-4">
      <div className="flex flex-col gap-4 w-80">
        <div className="flex gap-2 items-center">
          <div className="h-2 bg-gray-500 rounded-full w-[30%] animate-pulse"></div>
          <span className="text-gray-400">/</span>
          <div className="h-2 bg-gray-500 rounded-full w-[30%] animate-pulse"></div>
        </div>

        <div className="h-2 bg-gray-500 rounded-full w-[70%] animate-pulse"></div>
        <div className="h-2 bg-gray-500 rounded-full w-full animate-pulse"></div>
      </div>
